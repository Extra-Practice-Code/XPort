...
def generate ():
  ...
  output(os.path.join(outputdir, 'produsers.html'), 'produsers.html', { 'produsers': sorted(produsers.models, key=lambda r: str(getattr(r, r.label)).lower()), 'grouped_produsers': grouped_produsers })
